...
_0x0:
	.DB  0x48,0x65,0x6C,0x6C,0x6F,0x20,0x65,0x76
	.DB  0x65,0x72,0x79,0x62,0x6F,0x64,0x79,0x0
	.DB  0x49,0x27,0x6D,0x20,0x48,0x4F,0x4E,0x47
	.DB  0x44,0x41,0x54,0x43,0x48,0x59,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 00A3 // D4 - PORTB Bit 3
; 0000 00A4 // D5 - PORTB Bit 4
; 0000 00A5 // D6 - PORTB Bit 5
; 0000 00A6 // D7 - PORTC Bit 0
...
; 0000 00AD         lcd_puts("Hello everybody");
	__POINTW2MN _0x6,0
	RCALL SUBOPT_0x0
...
; 0000 00AF         lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 00B0         lcd_puts("I'm HONGDATCHY");
	__POINTW2MN _0x6,16
	RCALL SUBOPT_0x0
