...
_0x3:
	.DB  0x10,0x0,0x18,0x0,0x8,0x0,0xC,0x0
	.DB  0x4,0x0,0x6,0x0,0x2,0x0,0x12
_0x4:
	.DB  0x12,0x0,0x2,0x0,0x6,0x0,0x4,0x0
	.DB  0xC,0x0,0x8,0x0,0x18,0x0,0x10
_0x5:
	.DB  0x12,0x0,0x2,0x0,0x6,0x0,0x4,0x0
	.DB  0xC,0x0,0x8,0x0,0x18,0x0,0x10
_0x6:
...
_0x0:
	...
	.DB  0x65,0x0,0x43,0x6F,0x75,0x6E,0x74,0x65
	.DB  0x72,0x20,0x63,0x6C,0x6F,0x63,0x6B,0x0
	.DB  0x53,0x74,0x6F,0x70,0x21,0x0,0x57,0x65
	.DB  0x6C,0x63,0x6F,0x6D,0x65,0x21,0x0,0x53
	.DB  0x70,0x65,0x65,0x64,0x20,0x3D,0x20,0x25
	.DB  0x73,0x72,0x70,0x6D,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2040060:
	.DB  0x1
...
; 0000 003E         trunggian[i] =  clockwise_code[i];
	CALL SUBOPT_0x3
	CALL SUBOPT_0x4
	LDI  R26,LOW(_clockwise_code)
	LDI  R27,HIGH(_clockwise_code)
	CALL SUBOPT_0x5
...
; .FSTART _counterclockwise_rotate
...
; 0000 004E         trunggian[i] =  counterclockwise_code[i];
	CALL SUBOPT_0x3
	CALL SUBOPT_0x4
	LDI  R26,LOW(_counterclockwise_code)
	LDI  R27,HIGH(_counterclockwise_code)
	CALL SUBOPT_0x5
...
; 0000 0067         counterclockwise_rotate(delayTime);
	MOVW R26,R10
	RCALL _counterclockwise_rotate
; 0000 0068 
; 0000 0069      }
_0x16:
; 0000 006A }
...
; 0000 007F         if(trunggiantruoc[0] == clockwise_code[0]){
	LDS  R30,_clockwise_code
	LDS  R31,_clockwise_code+1
	LDS  R26,_trunggiantruoc
	LDS  R27,_trunggiantruoc+1
	CP   R30,R26
	CPC  R31,R27
	BRNE _0x1D
; 0000 0080             lcd_clear();
...
; 0000 008A           trunggian[i] = trunggiantruoc[i];
	CALL SUBOPT_0x3
	CALL SUBOPT_0x4
	LDI  R26,LOW(_trunggiantruoc)
	LDI  R27,HIGH(_trunggiantruoc)
	LSL  R30
	ROL  R31
	CALL SUBOPT_0x6
; 0000 008B         }
...
; 0000 00CD         ftoa(speed, 2, f2s_buffer);
	...
	LDI  R30,LOW(2)
	ST   -Y,R30
	LDI  R26,LOW(_f2s_buffer)
	LDI  R27,HIGH(_f2s_buffer)
	CALL _ftoa
; 0000 00CE         sprintf(buffer, "Speed = %srpm", f2s_buffer);
	...
	ST   -Y,R31
	ST   -Y,R30
	LDI  R30,LOW(_f2s_buffer)
	LDI  R31,HIGH(_f2s_buffer)
	CLR  R22
	CLR  R23
	CALL __PUTPARD1
	LDI  R24,4
...
SUBOPT_0x3:
	MOVW R30,R4
	LDI  R26,LOW(_trunggian)
	LDI  R27,HIGH(_trunggian)
	LSL  R30
	ROL  R31
	RET
